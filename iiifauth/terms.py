...
# Extensions for non-service auth demo:
CONTEXT_EXT_SERVICES = 'http://iiif.io/api/services_xxx/1/context.json'
PROFILE_EXT_SERVICES_INFO = 'http://iiif.io/api/services_xxx/1/info'
